...
<!--[if gt IE 9]><!-->	<html> <!--<![endif]-->
	<head>
		<meta charset="utf-8" />
		<title>Summit22</title>
		<meta name="keywords" content="HTML5,CSS3,Template" />
		<meta name="description" content="" />
		<meta name="Author" content="Cathleen Arnold" />
	...
	<body class="smoothscroll enable-animation">
		...
		<div id="wrapper">
				...
				<header id="topNav">
					<div class="container">
						...
						<a class="logo pull-left" href="index.html">
							...
							<h3>RIDGE22 Academic Coaching</h3>
						</a>
										...
										<ul class="dropdown-menu">
											<li class="dropdown active">
												...
												<ul class="dropdown-menu">
													...
													<li class="active"><a href="index-corporate-4.html">CORPORATE LAYOUT 4</a></li>
											...
											<li class="divider"></li>
											<li><a href="start.html#newrevslider" data-toggle="tooltip" data-placement="top" title="52 More Revolution Slider V5"><span class="label label-danger pull-right">new</span> 52 MORE LAYOUTS</a></li>
											<li class="divider"></li>
			...
			<!-- 
				...
				.height-800
			-->
			<section class="height-500" id="slider" style="background:url('assets/images/demo/1200x800/18-min.jpg')">
				...
				<div class="display-table">
					<div class="display-table-cell vertical-align-middle">
						...
						<div class="container text-center">
							...
							<h2 class="nomargin wow fadeInUp" data-wow-delay="0.4s">
								HELPING STUDENTS 
								<!--
									TEXT ROTATOR
							...
							<div class="row countTo-md text-center ">
								...
								<div class="col-xs-4 col-sm-4">
									...
									<span class="countTo" data-speed="3000">3000</span>
									<h5>HOURS TUTORED</h5>
								</div>

								<div class="col-xs-4 col-sm-4">
									<i class="icon-quote"></i>
									<span class="countTo" data-speed="3000">200</span>
									<h5>WORKSHOPS PRESENTED</h5>
								</div>
					
								<div class="col-xs-4 col-sm-4">
									<i class="icon-book"></i>
									<span class="countTo" data-speed="3000">98</span>
					...
					-->
							...
							<a class="btn btn-default btn-lg" href="#">SCHEDULE NOW</a>
			...
			<section>
				<div class="container">
					<!-- TODO ADD color background boxes -->
					<!-- FEATURED BOXES 3 -->
					<div class="row">
			...
			<section class="callout-dark heading-title heading-arrow-bottom">
				<div class="container">
					<div class="owl-carousel featured nomargin" data-plugin-options='{"singleItem": true, "stopOnHover":true, "autoPlay":true, "autoHeight": false, "navigation": false, "pagination": false}'>
						<div>
				...
				<div class="container">
					<div class="row">
						...
						<ul>
							...
							<li>Test Prep and Pacing The Brain and Learning
						</ul>	
						</div>
						<!-- skills -->
						<div class="col-md-4 col-sm-4">
							<h4>Your Academic Coach</h4>
							<ul>
								<li>
									Former High School and Middle School English Teacher 
								<li>	B.A. English Composition UNT Tarrant County College tutor/ writing workshop  developer/and presenter 
								<li>	Teacher of the Year - runner up 2007 and 2008 
								<li>	Online tutoring 
								<li>	Over 3000 tutoring hours 
								<li>	Tutoring diverse populations 
								<li>	Learning disabilities ADHD/Gifted and Talented 
								<li>	Second language learners 
							</ul>
						</div>
						<!-- /skills -->
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-3">
							...
							<label>RIDGE22 Academic Coaching</label>
